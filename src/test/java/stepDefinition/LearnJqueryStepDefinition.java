...
public class LearnJqueryStepDefinition extends BaseConfig {
	...
	public void Jquery_page() throws Throwable {
	...
	public void user_goes_to_the_LearnJquery_website() throws Throwable {
		...
		logger.info("age Scrolled Bottom");
		
		
	}

	@Then("^user click the chapters link and user get the navigated page url and page title and user get back to the home page$")
	public void user_click_the_chapters_link_and_user_get_the_navigated_page_url_and_page_title_and_user_get_back_to_the_home_page() throws Throwable {
	...
	public void user_click_the_Recently_Updated_link_and_user_get_the_navigated_page_url_and_page_title_and_user_get_back_to_the_home_page() throws Throwable {
